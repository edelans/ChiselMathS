 ...
 * License, Usage and Readme at http://.com
 */
 /********************************************
...
app.ui=(function(){
  ...
  //Camera position
  var cx = (window.innerWidth || document.body.clientWidth  || 640)*(-0.5);
  ...
  var ui={
    ...
    inputbox.appendChild(document.createTextNode(n.equation||""));
        ...
        //The below code is for focusing on the  when clicking to the right of it. It doesn't work with the latest . (2011-04-03)
